        ...
        return this.each(function () {
            ...
            if ($this.is('textarea')) {
                ...
                $editor.find('.bbcode-image').bind('click', function () {
                    var img_url = prompt('Enter a valid url to an image');
                    if (!img_url) { return; }
                ...
                $editor.find('.bbcode-code').bind('click', function() {
                    $cloned_textarea.surroundSelectedText('[code]', '[/code]', true);
                    $cloned_textarea.focus()
                });
